...
public record MaestroRequest(
    ...
    @Size(min = 5, max = 50, message = "El nombre del maestro debe tener entre 4 y 50 caracteres")
    String nombre,

    @NotBlank(message = "El apellido paterno es requerido")
    @Size(min = 5, max = 50, message = "El apellido paterno debe tener entre 40 y 50 caracteres")
    String apellidoPaterno,

    @NotBlank(message = "El apellido materno es requerido")
    @Size(min = 5, max = 50, message = "El apellido materno debe tener entre 40 y 50 caracteres")
